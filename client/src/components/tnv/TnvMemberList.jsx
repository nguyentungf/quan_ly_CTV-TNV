...
export default function TnvMemberList({
  ...
  const editableMembers = members.filter((m) => canEditGroup('tnv', m.group_num));
      ...
      <div className="p-3.5 sm:p-5 border-b border-slate-200/80 space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            ...
            {/* Thêm TNV Mới */}
            {isAdmin || (isLeader && user?.targetType === 'tnv') ? (
              <button
                onClick={onAddMember}
              ...
              <button
                ...
                title="Đăng nhập tài khoản để thêm TNV mới"
              >
            ...
            <tr className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200">
              <th className="p-3.5 pl-4 text-center w-10">
                <input
                  ...
                  className="rounded border-slate-300 text-rose-600 focus:ring-rose-500 cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
                  title={editableIds.length > 0 ? "Chọn tất cả TNV có quyền thao tác" : "Bạn không có quyền thao tác nhân sự nhóm nào"}
                />
              </th>
                  ...
                  >
                    ...
                    <td className="p-3.5 pl-4 text-center">
                      <input
                        ...
                        className="rounded border-slate-300 text-rose-600 focus:ring-rose-500 cursor-pointer disabled:opacity-25 disabled:cursor-not-allowed"
                      ...
                      {m.warning_level === 'canh_cao_2' ? (
                        isAdmin ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-black text-rose-900 bg-rose-100 border border-rose-300 hover:bg-rose-200 transition-colors cursor-pointer"
                          ...
                          <span
                            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-black text-rose-900 bg-rose-100 border border-rose-300"
                            title={m.warning_note || 'Thẻ Đỏ'}
                          >
                            <AlertOctagon className="w-3 h-3 text-rose-600" />
                            <span>Thẻ Đỏ</span>
                        ...
                        isAdmin ? (
                          <button
                            onClick={() => onEditWarning(m)}
                            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-black text-amber-900 bg-amber-100 border border-amber-300 hover:bg-amber-200 transition-colors cursor-pointer"
                          ...
                          <span
                            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-black text-amber-900 bg-amber-100 border border-amber-300"
                            title={m.warning_note || 'Thẻ Vàng'}
                          >
                            <AlertTriangle className="w-3 h-3 text-amber-600" />
                            <span>Thẻ Vàng</span>
